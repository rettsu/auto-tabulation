<?php if ($result): ?>
	<?php foreach ($result as $i => $val): ?>
          <tr>
            ...
            <div class="col col-sm-2">
                <td>
                    <input type="number" min="1" max="100" class="form-control" name="txtCreativity<?php echo $val->id; ?>'" id="txtCreativity<?php echo $val->id; ?>" autocomplete="off" required>
                </td>
            </div>

            <div class="col col-sm-2">
                <td>
                    <input type="number" min="1" max="100" class="form-control" name="txtMusic<?php echo $val->id; ?>" id="txtMusic<?php echo $val->id; ?>" autocomplete="off" required style="width:100%;">
                </td>
            </div>

            <div class="col col-sm-2">
                <td>
                    <input type="number" min="1" max="100" class="form-control" name="txtOriginality<?php echo $val->id; ?>" id="txtOriginality<?php echo $val->id; ?>" autocomplete="off" required style="width:100%;">
                </td>
            </div>
            <div class="col col-sm-2" style="margin-right: -10px;">
                 <td>
                    <button class="btn btn-theme03 add-tabS" style="width: 100%;" type="button" data="<?php echo $val->id; ?>">
