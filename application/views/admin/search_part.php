        ...
        <?php $i = $i + 1; ?>
          <tr>
            ...
            <div class="col col-sm-2">
                 <td style="text-align: center;">
                    <button style="100%" class="btn btn-theme02 edit-part" type="button" data="<?php echo $val->id; ?>" title="Edit Information">
                    	<span class="fa fa-edit"></span>
                    </button>
                    <button style="100%" class="btn btn-theme04 del-part" type="button" data="<?php echo $val->id; ?>" title="Remove Participant">
